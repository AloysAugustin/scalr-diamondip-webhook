...
payload = """{
    ...
    "data": {
        ...
        "SCALR_EVENT_EXTERNAL_IP": "54.81.159.120",
        ...
        "SCALR_SERVER_HOSTNAME": "ec2-54-81-159-120.compute-1.amazonaws.com",
        "SCALR_EVENT_INTERNAL_IP": "10.139.20.5",
        "SCALR_ROLE_NAME": "base64-ubuntu1204",
        "SCALR_INTERNAL_IP": "10.139.20.5",
...
r = requests.post('http://localhost:5000/', headers=headers, data=payload)
print r.status_code
print r.text
